...
parser = OptionParser()
parser.add_option('-e', '--expectedPath', default = './pat_metuncer_expected.root', action = 'store', type = 'string')
parser.add_option('-a', '--actualPath', default = './pat_metuncer_actual.root', action = 'store', type = 'string')
...
class METProducerTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.exHandlePatMETs = Handle("std::vector<pat::MET>") 
        self.acHandlePatMETs = Handle("std::vector<pat::MET>") 
    ...
    def test_patMETs_patType1CorrectedPFMetMuonEnDown(self):
        exLabel = ("patType1CorrectedPFMetMuonEnDown" ,"" ,"PAT")
        acLabel = exLabel
        exHandle = self.exHandlePatMETs
        acHandle = self.acHandlePatMETs
    ...
    def test_patMETs_patType1CorrectedPFMetMuonEnUp(self):
        exLabel = ("patType1CorrectedPFMetMuonEnUp", "", "PAT")
        acLabel = exLabel
        exHandle = self.exHandlePatMETs
        acHandle = self.acHandlePatMETs
        candidateAssertMethods = ('assert_recoLeafCandidate', 'assert_recoMET')
    ...
    def test_patMETs_patType1CorrectedPFMetTauEnDown(self):
        exLabel = ("patType1CorrectedPFMetTauEnDown", "", "PAT")
        acLabel = exLabel
        exHandle = self.exHandlePatMETs
        acHandle = self.acHandlePatMETs
        candidateAssertMethods = ('assert_recoLeafCandidate', 'assert_recoMET')
    ...
    def test_patMETs_patType1CorrectedPFMetTauEnUp(self):
        exLabel = ("patType1CorrectedPFMetTauEnUp", "", "PAT")
        acLabel = exLabel
        exHandle = self.exHandlePatMETs
        acHandle = self.acHandlePatMETs
        candidateAssertMethods = ('assert_recoLeafCandidate', 'assert_recoMET')
    ...
    def test_patMETs_patType1CorrectedPFMetUnclusteredEnDown(self):
        exLabel = ("patType1CorrectedPFMetUnclusteredEnDown", "", "PAT")
        acLabel = exLabel
        exHandle = self.exHandlePatMETs
        acHandle = self.acHandlePatMETs
        candidateAssertMethods = ('assert_recoLeafCandidate', 'assert_recoMET')
    ...
    def test_patMETs_patType1CorrectedPFMetUnclusteredEnUp(self):
        exLabel = ("patType1CorrectedPFMetUnclusteredEnUp", "", "PAT")
        acLabel = exLabel
        exHandle = self.exHandlePatMETs
        acHandle = self.acHandlePatMETs
        candidateAssertMethods = ('assert_recoLeafCandidate', 'assert_recoMET')
    ...
    def test_patMETs_patType1p2CorrectedPFMet(self):
        exLabel = ("patType1p2CorrectedPFMet", "", "PAT")
        acLabel = exLabel
        exHandle = self.exHandlePatMETs
        acHandle = self.acHandlePatMETs
        candidateAssertMethods = ('assert_recoLeafCandidate', 'assert_recoMET')
    ...
    def test_patMETs_patType1p2CorrectedPFMetElectronEnDown(self):
        exLabel = ("patType1p2CorrectedPFMetElectronEnDown", "", "PAT")
        acLabel = exLabel
        exHandle = self.exHandlePatMETs
        acHandle = self.acHandlePatMETs
        candidateAssertMethods = ('assert_recoLeafCandidate', 'assert_recoMET')
    ...
    def test_patMETs_patType1p2CorrectedPFMetElectronEnUp(self):
        exLabel = ("patType1p2CorrectedPFMetElectronEnUp", "", "PAT")
        acLabel = exLabel
        exHandle = self.exHandlePatMETs
        acHandle = self.acHandlePatMETs
        candidateAssertMethods = ('assert_recoLeafCandidate', 'assert_recoMET')
    ...
    def test_patMETs_patType1p2CorrectedPFMetJetEnDown(self):
        exLabel = ("patType1p2CorrectedPFMetJetEnDown", "", "PAT")
        acLabel = exLabel
        exHandle = self.exHandlePatMETs
        acHandle = self.acHandlePatMETs
        candidateAssertMethods = ('assert_recoLeafCandidate', 'assert_recoMET')
    ...
    def test_patMETs_patType1p2CorrectedPFMetJetEnUp(self):
        exLabel = ("patType1p2CorrectedPFMetJetEnUp", "", "PAT")
        acLabel = exLabel
        exHandle = self.exHandlePatMETs
        acHandle = self.acHandlePatMETs
        candidateAssertMethods = ('assert_recoLeafCandidate', 'assert_recoMET')
    ...
    def test_patMETs_patType1p2CorrectedPFMetJetResDown(self):
        exLabel = ("patType1p2CorrectedPFMetJetResDown", "", "PAT")
        acLabel = exLabel
        exHandle = self.exHandlePatMETs
        acHandle = self.acHandlePatMETs
        candidateAssertMethods = ('assert_recoLeafCandidate', 'assert_recoMET')
    ...
    def test_patMETs_patType1p2CorrectedPFMetJetResUp(self):
        exLabel = ("patType1p2CorrectedPFMetJetResUp", "", "PAT")
        acLabel = exLabel
        exHandle = self.exHandlePatMETs
        acHandle = self.acHandlePatMETs
        candidateAssertMethods = ('assert_recoLeafCandidate', 'assert_recoMET')
    ...
    def test_patMETs_patType1p2CorrectedPFMetMuonEnDown(self):
        exLabel = ("patType1p2CorrectedPFMetMuonEnDown", "", "PAT")
        acLabel = exLabel
        exHandle = self.exHandlePatMETs
        acHandle = self.acHandlePatMETs
        candidateAssertMethods = ('assert_recoLeafCandidate', 'assert_recoMET')
    ...
    def test_patMETs_patType1p2CorrectedPFMetMuonEnUp(self):
        exLabel = ("patType1p2CorrectedPFMetMuonEnUp", "", "PAT")
        acLabel = exLabel
        exHandle = self.exHandlePatMETs
        acHandle = self.acHandlePatMETs
        candidateAssertMethods = ('assert_recoLeafCandidate', 'assert_recoMET')
    ...
    def test_patMETs_patType1p2CorrectedPFMetTauEnDown(self):
        exLabel = ("patType1p2CorrectedPFMetTauEnDown", "", "PAT")
        acLabel = exLabel
        exHandle = self.exHandlePatMETs
        acHandle = self.acHandlePatMETs
        candidateAssertMethods = ('assert_recoLeafCandidate', 'assert_recoMET')
    ...
    def test_patMETs_patType1p2CorrectedPFMetTauEnUp(self):
        exLabel = ("patType1p2CorrectedPFMetTauEnUp", "", "PAT")
        acLabel = exLabel
        exHandle = self.exHandlePatMETs
        acHandle = self.acHandlePatMETs
        candidateAssertMethods = ('assert_recoLeafCandidate', 'assert_recoMET')
    ...
    def test_patMETs_patType1p2CorrectedPFMetUnclusteredEnDown(self):
        exLabel = ("patType1p2CorrectedPFMetUnclusteredEnDown", "", "PAT")
        acLabel = exLabel
        exHandle = self.exHandlePatMETs
        acHandle = self.acHandlePatMETs
        candidateAssertMethods = ('assert_recoLeafCandidate', 'assert_recoMET')
    ...
    def test_patMETs_patType1p2CorrectedPFMetUnclusteredEnUp(self):
        exLabel = ("patType1p2CorrectedPFMetUnclusteredEnUp", "", "PAT")
        acLabel = exLabel
        exHandle = self.exHandlePatMETs
        acHandle = self.acHandlePatMETs
        candidateAssertMethods = ('assert_recoLeafCandidate', 'assert_recoMET')
